...
(function () {
  ...
  const listTraverseOp = {
    ...
    frames: [
      list('כדי למצוא ערך יש ללכת מהראש — אין גישה אקראית. נחפש את 9.', [7, 4, 9, 2], { head: 0, curr: 0 }, { 0: ACTIVE }),
      list('curr = 7. לא 9 → עוברים לצומת הבא.', [7, 4, 9, 2], { curr: 1 }, { 1: ACTIVE }),
      list('curr = 4. לא 9 → ממשיכים.', [7, 4, 9, 2], { curr: 2 }, { 2: ACTIVE }),
